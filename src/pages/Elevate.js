          ...
          <div className="hero-text-area   ">
            <div className="row">
              ...
              <div className="col-12       ">
                ...
                <h1 className="hero-title  ">Virtual Incubation Program for <span className="featured-text">Startup <svg xmlns="http://www.w3.org/2000/svg" className="wavey-underline" width="1104.664" height="100.188" viewBox="0 0 1104.664 100.188">
              ...
              <div className="col-10">
                                              ...
                                              A virtual incubation center is a digital platform designed to support startups, entrepreneurs, and small businesses by providing essential resources, mentorship, and networking opportunities — all accessible remotely. Unlike traditional incubation centers, which require physical space and in-person meetings, virtual incubation centers use online tools to facilitate growth, enabling participants to connect from anywhere with internet access.
                </p>
              </div>
              <div className="col-12   ">
  ...
  <section className="services services-boxed mega-section  " id="services">
    <div className="container">
      <div className="sec-heading  ">
        <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">Program</span>
          <h2 className=" title    wow fadeInUp" data-wow-delay=".4s"><span className="hollow-text">Program</span> Structure
          </h2>
          <p className="subtitle   wow fadeInUp " data-wow-delay=".6s">Phases & Stages </p>
        </div>
      ...
      <div className="row gx-4 gy-4 services-row ">
        ...
        <h3 className="service-title">Alpha (Free)</h3>
                                          <p className="service-text">
                                          Targeted at very early-stage startups. Services include basic guidance, idea validation, draft business model, access to resources, and community support.
        </p>
        </div><Link className="read-more" to="/Alpha">read more<i className="bi bi-arrow-right icon " /></Link>
        </div>
        ...
        <p className="service-text">Introduction of service charges. Focus on refining business models, developing MVPs, and legal compliance.</p>
        </div><Link className="read-more" to="/Beta">read more<i className="bi bi-arrow-right icon " /></Link>
        </div>
        {/* End First service box   */}
        </div>
        <div className="col-12 col-md-3  col-lg-3 mx-auto ">
        ...
        <p className="service-text">Advanced support with increased service offerings, mentorship, and funding guidance.</p>
        </div><Link className="read-more" to="/Gamma">read more<i className="bi bi-arrow-right icon " /></Link>
        </div>
        ...
        <p className="service-text">Final phase focusing on expansion, fund raising, team building, and advanced business strategies.</p>
        </div><Link className="read-more" to="/Sigma">read more<i className="bi bi-arrow-right icon " /></Link>
        </div>
        {/* End First service box   */}
        </div>
          ...
          <div className="col-12 col-lg-6 d-flex align-items-center about-col pad-start  wow fadeInUp " data-wow-delay="0.6s">
            <div className="text-area ">
              <div className="sec-heading  light-title ">
                <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">Features</span>
                  <h2 className=" title    wow fadeInUp" data-wow-delay=".4s">AI Empowered   <span className="hollow-text">
                  Features</span> 
                     </h2>
                </div>
              </div>
                  ...
                  <div className="col-12 ">
                    <div className="info-item"><span className="info-number ">01.</span>
                      <div className="info-content">
                        <h5 className="info-title">Business Idea Review </h5>
                        <p className="info-text">Rank ideas against a well-trained AI model of successful and failed models and predict the chances of the success of this business idea, list out the potential impediments and plan to handle each one of them. </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 ">
                    <div className="info-item"><span className="info-number ">02.</span>
                      <div className="info-content">
                        <h5 className="info-title">Revenue Model Prediction</h5>
                        <p className="info-text">Generate potential business and revenue models.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 ">
                    <div className="info-item"><span className="info-number ">03.</span>
                      <div className="info-content">
                        <h5 className="info-title">KRA Setting </h5>
                        <p className="info-text">Automate the generation of bi-monthly Key Result Areas tailored to each startup.</p>
                      </div>
                    </div>
                                                  </div>
                 <div className="col-12 ">
                    <div className="info-item"><span className="info-number ">04.</span>
                      <div className="info-content">
                        <h5 className="info-title">Growth Plan Generation </h5>
                                                              <p className="info-text">
                                                              Provide a roadmap for growth for each quarter.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <div className="sec-heading  ">
        <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">pricing plans</span>
          <h2 className=" title    wow fadeInUp" data-wow-delay=".4s"><span className="hollow-text">affordable</span> pricing
            plans</h2>
          <p className="subtitle   wow fadeInUp " data-wow-delay=".6s">Charges (India, Malaysia, Thailand and Indonesia) </p>
        </div>
        ...
        <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
          <div className="plan    wow fadeInUp  " data-wow-delay=".1s ">
            <div className="plan-head"><i className="flaticon-nft-1 plan-icon" />
              <h4 className="plane-name">Alpha (free plan)</h4>
              <div className="plan-price">
                <h3 className="price">00<sup className="currency-symbol">$</sup></h3><span className="per">per seat</span>
              </div>
            </div>
        ...
        <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
          <div className="plan    wow fadeInUp  " data-wow-delay=".3s ">
            <div className="plan-head"><i className="flaticon-virtual-reality plan-icon" />
              <h4 className="plane-name">Beta plan</h4>
              <div className="plan-price">
                <h3 className="price">101<sup className="currency-symbol">$</sup></h3><span className="per">per seat</span>
              </div>
            </div>
            <div className="plan-details">
              <ul className="plan-list">
        ...
        <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
          <div className="plan   featured  wow fadeInUp  " data-wow-delay=".5s ">
            <div className="plan-head"><i className="flaticon-box plan-icon" />
              <h4 className="plane-name">Gamma plan</h4>
              <div className="plan-price">
                <h3 className="price">225<sup className="currency-symbol">$</sup></h3><span className="per">per seat</span>
              </div>
            </div>
            <div className="plan-details">
              <ul className="plan-list">
        ...
        <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
          <div className="plan    wow fadeInUp  " data-wow-delay=".6s ">
            <div className="plan-head"><i className="flaticon-basic-shapes plan-icon" />
              <h4 className="plane-name">Sigma Plan</h4>
              <div className="plan-price">
                <h3 className="price">454<sup className="currency-symbol">$</sup></h3><span className="per">per seat</span>
              </div>
            </div>
            <div className="plan-details">
              <ul className="plan-list">
    ...
    <div className="container">
      <div className="sec-heading  centered ">
        <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">testimonials</span>
          <h2 className=" title    wow fadeInUp" data-wow-delay=".4s">Startup <span className="hollow-text">testmonials</span>
          </h2>
        </div>
      </div>

...
export default function About() {
  ...
  <section className="page-hero  d-flex align-items-center" id="page-hero">
    <div className="overlay-photo-image-bg" data-bg-img="./assets/assets/images/sections-bg-images/pattern-bg-2.jpg" data-bg-opacity=".2" />
    <div className="particles-js  bubels" id="particles-js" />
    <div className="container">
      <div className="row align-items-center">
        {/*start of .image-area */}
        <div className="col-12   mx-md-auto col-lg-6 text-center " data-tilt>
          <div className="hero-image-area mb-5 mb-lg-0">
            <div className="hero-img-wraper  "><img className="img-fluid " src="./assets/assets/images/hero/illustration-4.png" alt draggable="false" /></div>
          </div>
        </div>
        {/*End of .image-area */}
    ...
    <div className="container">
      <div className="sec-heading  ">
        <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">services</span>
          ...
          <p className="subtitle   wow fadeInUp " data-wow-delay=".6s">Lorem ipsum dolor sit amet consectetur adipisicing
            elit Omnis <br />id atque dignissimos repellat quae ullam.</p>
        </div>
        <div className=" cta-area   wow fadeInUp" data-wow-delay=".8s"><a className="cta-btn btn-solid    ">see all services <i className="bi bi-arrow-right icon " /></a></div>
      </div>
        ...
        <div className="col-12 col-md-6  col-lg-4 mx-auto ">
          ...
          <div className="box service-box  wow fadeInUp reveal-start" data-wow-offset={0} data-wow-delay=".1s">
            ...
            <div className="service-content">
              ...
              <p className="service-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque repellendus minima
                reiciendis nobis dolore obcaecati.</p>
        ...
        <div className="row">
          <div className="col-12 col-lg-6 d-flex align-items-center about-col  wow fadeInUp" data-wow-delay="0.2s">
            <div className="img-area  ">
              <div className="image  " data-tilt><img className="about-img img-fluid " loading="lazy" src="./assets/assets/images/about/2.png" alt="about" /></div>
            </div>
          </div>
          <div className="col-12 col-lg-6 d-flex align-items-center about-col pad-start  wow fadeInUp " data-wow-delay="0.6s">
            <div className="text-area ">
              <div className="sec-heading  light-title ">
                <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">why choose
                    us</span>
                  <h2 className=" title    wow fadeInUp" data-wow-delay=".4s">Why our <span className="hollow-text">
                      customers</span> choose <span className="featured-text">working <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 150" preserveAspectRatio="none">
                        <path d="M7.7,145.6C109,125,299.9,116.2,401,121.3c42.1,2.2,87.6,11.8,87.3,25.7" />
                      </svg></span> with us</h2>
                </div>
              </div>
              <p className=" about-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. A officia molestiae
                dolorum tempora ut accusamus cupiditate! Nesciunt tempora reiciendis libero voluptate!</p>
                  ...
                  <div className="col-12 ">
                    <div className="info-item"><span className="info-number ">01.</span>
                      <div className="info-content">
                        ...
                        <p className="info-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque repellendus
              ...
              <div className="cta-area "><a className=" btn-solid " href="about-us.html">get in toutch</a></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <section className="stats js-stats-counter mega-section">
    <div className="overlay-photo-image-bg" data-bg-img="./assets/assets/images/sections-bg-images/pattern-bg-3.jpg" data-bg-opacity=".2" />
    <div className="container">
        ...
        <div className="row ">
          ...
          <div className="col-12 col-md-6 col-lg-3 stat-box ">
            <div className="stat-box-inner  " data-tilt="data-tilt"><i className="flaticon-project-management stat-icon" />
              <p className="stat-num "><span className="counter" data-from={10} data-to={750} data-speed={3000} data-refresh-interval={50} /><span className="sign">+</span></p><span className="stat-desc">finished
                projects</span>
            </div>
          </div>
          {/*Info Two*/}
          <div className="col-12 col-md-6 col-lg-3 stat-box ">
            <div className="stat-box-inner  " data-tilt="data-tilt"><i className="flaticon-content-management stat-icon" />
              <p className="stat-num "><span className="counter" data-from={0} data-to={23} data-speed={3000} data-refresh-interval={50} /><span className="sign">+</span></p><span className="stat-desc">Created
                jobs</span>
            </div>
          </div>
          {/*Info Three*/}
          <div className="col-12 col-md-6 col-lg-3 stat-box ">
            <div className="stat-box-inner  " data-tilt="data-tilt"><i className="flaticon-user stat-icon" />
              <p className="stat-num "><span className="counter" data-from={0} data-to={200} data-speed={3000} data-refresh-interval={50} /><span className="sign">+</span></p><span className="stat-desc">happy
                customers</span>
            </div>
          </div>
          {/*Info Four*/}
          <div className="col-12 col-md-6 col-lg-3 stat-box ">
            <div className="stat-box-inner  " data-tilt="data-tilt"><i className="flaticon-aim stat-icon" />
              <p className="stat-num "><span className="counter" data-from={0} data-to={28} data-speed={3000} data-refresh-interval={50} /><span className="sign">+</span></p><span className="stat-desc">years Of
                exprience</span>
            </div>
          </div>
        </div>
  ...
  <section className="pricing mega-section  " id="pricing-1">
    <div className="container">
      <div className="sec-heading  ">
        <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">pricing plans</span>
          <h2 className=" title    wow fadeInUp" data-wow-delay=".4s"><span className="hollow-text">affordable</span> pricing
            plans</h2>
          <p className="subtitle   wow fadeInUp " data-wow-delay=".6s">Lorem ipsum dolor sit amet consectetur adipisicing
            elit Omnis <br />id atque dignissimos repellat quae ullam.</p>
        </div>
        <div className=" cta-area   wow fadeInUp" data-wow-delay=".8s"><a className="cta-btn btn-solid    " href="pricing.html">see all plans<i className="bi bi-arrow-right icon " /></a></div>
      </div>
      <div className="row">
        {/*First Plan*/}
        <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
          <div className="plan    wow fadeInUp  " data-wow-delay=".1s ">
            <div className="plan-head"><i className="flaticon-nft-1 plan-icon" />
              <h4 className="plane-name">free plan</h4>
              <div className="plan-price">
                <h3 className="price">00<sup className="currency-symbol">$</sup></h3><span className="per">per project</span>
              </div>
            </div>
            <div className="plan-details">
              <ul className="plan-list">
                <li className="plan-feat "> <span className="feat-text"> 150 Lorem, ipsum dolor. </span></li>
                <li className="plan-feat "> <span className="feat-text"> 20 Lorem ipsum dolor sit . </span></li>
                <li className="plan-feat "> <span className="feat-text"> Lorem ipsum dolor sit. </span></li>
                <li className="plan-feat "> <span className="feat-text"> free Lorem ipsum dolor . </span></li>
                <li className="plan-feat "> <span className="feat-text"> added Lorem ipsum dolor. </span></li>
              </ul>
            </div>
            <div className="plan-cta"><a className="cta-btn btn-outline " href="#0">select plan </a></div>
          </div>
        </div>
        {/*Second-plan*/}
        <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
          <div className="plan    wow fadeInUp  " data-wow-delay=".3s ">
            <div className="plan-head"><i className="flaticon-virtual-reality plan-icon" />
              <h4 className="plane-name">standerd plan</h4>
              <div className="plan-price">
                <h3 className="price">85<sup className="currency-symbol">$</sup></h3><span className="per">per project</span>
              </div>
            </div>
            <div className="plan-details">
              <ul className="plan-list">
        ...
        {/*Third-plan*/}
        <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
          <div className="plan   featured  wow fadeInUp  " data-wow-delay=".5s ">
            <div className="plan-head"><i className="flaticon-box plan-icon" />
              <h4 className="plane-name">pro plan</h4>
              <div className="plan-price">
                <h3 className="price">150<sup className="currency-symbol">$</sup></h3><span className="per">per project</span>
              </div>
            </div>
            <div className="plan-details">
              <ul className="plan-list">
        ...
        <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
          <div className="plan    wow fadeInUp  " data-wow-delay=".6s ">
            <div className="plan-head"><i className="flaticon-basic-shapes plan-icon" />
              <h4 className="plane-name">ultimate plan</h4>
              <div className="plan-price">
                <h3 className="price">210<sup className="currency-symbol">$</sup></h3><span className="per">per project</span>
              </div>
            </div>
            <div className="plan-details">
              <ul className="plan-list">
  ...
  <section className="testimonials testimonials-1-col   has-dark-bg  mega-section " id="testimonials-img-bg">
    <div className="overlay-photo-image-bg parallax " data-bg-img="./assets/assets/images/sections-bg-images/1.jpg" data-bg-opacity=".25"> </div>
    <div className="container">
      <div className="sec-heading  centered ">
        <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">testimonials</span>
          <h2 className=" title    wow fadeInUp" data-wow-delay=".4s">customers <span className="hollow-text">testmonials</span>
          </h2>
        </div>
      </div>
          ...
          <div className="swiper-container  wow fadeInUp  " data-wow-delay="0.2s">
            <div className="swiper-wrapper">
              ...
              <div className="swiper-slide">
                <div className="testmonial-card d-flex align-items-center justify-content-center">
                  <div className="testimonial-content">
                    <div className="customer-img "><img className="img-fluid " loading="lazy" src="./assets/assets/images/testimonials/1.png" alt="First Slide " /></div>
                    <div className="customer-testimonial">
                      <div className="content">
                        <p className="testimonial-text "> ipsum dolor sit amet consectetur adipisicing elit. Quod, id sequi
              ...
              <div className="swiper-slide">
                <div className="testmonial-card d-flex align-items-center justify-content-center">
                  <div className="testimonial-content">
                    <div className="customer-img "><img className="img-fluid " loading="lazy" src="./assets/assets/images/testimonials/2.png" alt="First Slide " /></div>
                    <div className="customer-testimonial">
                      <div className="content">
                        <p className="testimonial-text "> ipsum dolor sit amet consectetur adipisicing elit. Quod, id sequi
                          aut qui est ab, corporis quis maiores reiciendis explicabo odio tenetur nulla sint vel.</p>
              ...
              <div className="swiper-slide">
                <div className="testmonial-card d-flex align-items-center justify-content-center">
                  <div className="testimonial-content">
                    <div className="customer-img "><img className="img-fluid " loading="lazy" src="./assets/assets/images/testimonials/3.png" alt="First Slide " /></div>
                    <div className="customer-testimonial">
                      <div className="content">
                        <p className="testimonial-text "> ipsum dolor sit amet consectetur adipisicing elit. Quod, id sequi
                          aut qui est ab, corporis quis maiores reiciendis explicabo odio tenetur nulla sint vel. </p>
            ...
            <div className="swiper-button-prev">
              <div className="left-arrow"><i className="bi bi-chevron-left icon " />
              </div>
            </div>
            <div className="swiper-button-next">
              <div className="right-arrow"><i className="bi bi-chevron-right icon " />
              </div>
            </div>
          </div>
        </div>
  ...
  <section className="blog blog-home mega-section  " id="blog">
    <div className="container ">
      <div className="sec-heading  ">
        <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">blog</span>
            ...
            <div className="row">
              <div className="col-12 col-lg-4 ">
                <div className="post-box"> <a className="post-link" href="post-single.html" title="How litespeed technology works to speed up your site ">
                    <div className="post-img-wrapper  "><img className=" parallax-img   post-img" loading="lazy" src="./assets/assets/images/blog/post-images/1.jpg" alt /><span className="post-date"><span className="day">05
                  ...
                  <div className="post-summary">
                    ...
                    <div className="post-text"><a className="post-link" href="post-single.html">
                        <h2 className="post-title"> How litespeed technology works to speed up your site </h2>
                      </a>
                      <p className="post-excerpt">Lorem ipsum dolor sit, amet consectetur adipisicing elit.Iure nulla
                        dolorem, voluptates molestiae</p><a className="read-more" href="post-single.html" title="How litespeed technology works to speed up your site ">read more<i className="bi bi-arrow-right icon " /></a>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-12 col-lg-4 ">
                <div className="post-box"> <a className="post-link" href="post-single.html" title="give your website a new look and feel with themes">
                    <div className="post-img-wrapper  "><img className=" parallax-img   post-img" loading="lazy" src="./assets/assets/images/blog/post-images/2.jpg" alt /><span className="post-date"><span className="day">15
                        </span>sep 2022 </span></div>
                  </a>
                  <div className="post-summary">
                    <div className="post-info"><a className="info post-cat" href="#"> <i className="bi bi-bookmark icon" />web
                        dev</a><a className="info post-author" href="#"> <i className=" bi bi-person icon" />mhmd amin</a>
                    </div>
                    <div className="post-text"><a className="post-link" href="post-single.html">
                        <h2 className="post-title"> give your website a new look and feel with themes</h2>
                      </a>
                      <p className="post-excerpt">Lorem ipsum dolor sit, amet consectetur adipisicing elit.Iure nulla
                        dolorem, voluptates molestiae</p><a className="read-more" href="post-single.html" title="give your website a new look and feel with themes">read more<i className="bi bi-arrow-right icon " /></a>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-12 col-lg-4 ">
                <div className="post-box"> <a className="post-link" href="post-single.html" title="the role of domain names in SEO world explained ">
                    <div className="post-img-wrapper  "><img className=" parallax-img   post-img" loading="lazy" src="./assets/assets/images/blog/post-images/3.jpg" alt /><span className="post-date"><span className="day">27
                  ...
                  <div className="post-summary">
                    ...
                    <div className="post-text"><a className="post-link" href="post-single.html">
                        <h2 className="post-title"> the role of domain names in SEO world explained </h2>
                      </a>
                      <p className="post-excerpt">Lorem ipsum dolor sit, amet consectetur adipisicing elit.Iure nulla
                        dolorem, voluptates molestiae</p><a className="read-more" href="post-single.html" title="the role of domain names in SEO world explained ">read more<i className="bi bi-arrow-right icon " /></a>
                    </div>
                  </div>
                </div>
              </div>

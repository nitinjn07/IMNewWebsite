        ...
        <div>
          ...
          >
            <div
              ...
              data-bg-img="./assets/assets/images/sections-bg-images/pattern-bg-2.jpg"
              data-bg-opacity=".2"
            />
                ...
                >
                  <div className="hero-image-area mb-5 mb-lg-0">
                    <div className="hero-img-wraper  ">
                      <img
                        className="img-fluid "
                        src="./assets/assets/images/hero/illustration-4.png"
                        alt
                        draggable="false"
                      />
                    </div>
                    ...
                    <div className="row">
                      <div className="col-12   ">
                        <div className="hero-social-icons mb-3 ">
                          <div className="sc-wrapper dir-row sc-flat"></div>
                        </div>
                      </div>
                      <div className="col-12       ">
                        ...
                        <h1 className="hero-title  ">
                          ...
                          <span className="design-element rounded-shape stripes" />
                        </h1>
                      </div>
                    ...
                    <div className="img-area  ">
                      <div className="image  " data-tilt>
                        <img
                          ...
                          loading="lazy"
                          src="./assets/assets/images/about/2.png"
                          alt="about"
                        />
                      </div>
                    </div>
                  ...
                  >
                    <div className="text-area ">
                      <div className="sec-heading  light-title ">
                        <div className="content-area">
                          ...
                          <h2
                            ...
                            data-wow-delay=".4s"
                          >
                            Key Offerings of EIM
                            <span className="hollow-text">Features</span>
                          </h2>
                        </div>
                      </div>
                        ...
                        <div className="row ">
                            ...
                            <div className="info-item">
                              ...
                              <div className="info-content">
                                ...
                                <p className="info-text">
                                  • EIM’s immersive platform creates a
                                  comprehensive and resourceful ecosystem for
                                  startups, simulating real-world environments
                                  for collaboration, networking, and mentorship.
                                </p>
                              </div>
                            </div>
                          </div>
                          <div className="col-12 ">
                            <div className="info-item">
                              ...
                              <div className="info-content">
                                <h5 className="info-title">
                                  AI Empowered Financial Modelling
                                </h5>
                                <p className="info-text">
                                  • Our AI-driven system helps startups generate
                                  tailored business and revenue models. This
                                  predictive tool ensures that each startup is
                                  equipped with a financially viable strategy,
                                  optimized for profitability & scalability.
                                </p>
                              </div>
                            </div>
                          </div>
                          <div className="col-12 ">
                            <div className="info-item">
                              ...
                              <div className="info-content">
                                ...
                                <p className="info-text">
                                  • We connect startups with dedicated mentors
                                  whose expertise aligns with their specific
                                  business challenges. The platform matches
                                  entrepreneurs with experienced advisors to
                                  guide them through crucial business decisions.
                                </p>
                              </div>
                            </div>
                          </div>
                          <div className="col-12 ">
                            <div className="info-item">
                              ...
                              <div className="info-content">
                                <h5 className="info-title">
                                  Investor Access and Funding Guidance
                                </h5>
                                <p className="info-text">
                                  Startups in the EIM program are granted access
                                  to a network of investors seeking
                                  high-potential ventures. Through personalized
                                  pitch coaching and business model
                                  optimization, EIM prepares startups for
                          ...
                          <div className="col-12 ">
                            <div className="info-item">
                              ...
                              <div className="info-content">
                                ...
                                <p className="info-text">
                                  EIM’s data-driven platform provides startups
                                  with real-time analytics on key business
                                  metrics, from market performance to financial
                                  health. Entrepreneurs can make data-informed
                          ...
                          <div className="col-12 ">
                            <div className="info-item">
                              ...
                              <div className="info-content">
                                <h5 className="info-title">
                                  Quick Access to Vital Startup Resources
                                </h5>
                                <p className="info-text">
                                  We provide startups with instant access to a
                                  wide range of resources, including templates,
                                  legal documents, financial tools, team of
                                  lawyers, chartered accounts, human resources,
                                  compliance managers, marketing strategies, and
                                  more.
                                </p>
                              </div>
                            </div>
                      ...
                      <div className="cta-area ">
                        <a className=" btn-solid " href="about-us.html">
                          get in toutch
                        </a>
                      </div>
                    </div>
            ...
            <div className="container">
              <div className="sec-heading  ">
                <div className="content-area">
                  ...
                  <h2 className=" title    wow fadeInUp" data-wow-delay=".4s">
                    <span className="hollow-text">affordable</span> pricing
                    plans
                  </h2>
                  <p className="subtitle   wow fadeInUp " data-wow-delay=".6s">
                    EIM offers flexible and cost-effective pricing plans
                    tailored to suit the needs of your startup.
                  </p>
                </div>
                <div className=" cta-area   wow fadeInUp" data-wow-delay=".8s">
                  <a className="cta-btn btn-solid    " href="pricing.html">
                    Subscribe Now
                    <i className="bi bi-arrow-right icon " />
                  </a>
                </div>
              ...
              <div className="row">
                ...
                <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
                  <div
                    className="plan  text-center wow fadeInUp  "
                    data-wow-delay=".1s "
                  >
                    <div className="plan-head">
                      <i className="flaticon-nft-1 plan-icon" />
                      <h4 className="plane-name">Alpha (Trial)</h4>
                    ...
                    <div className="plan-details">
                      <ul className="plan-list">
                        <li className="plan-feat ">
                          <span className="feat-text">o Duration: 4 Weeks</span>
                        </li>
                        <li className="plan-feat ">
                          <span className="feat-text">
                            o Dedicated Mentors : 2
                          </span>
                        </li>
                        <li className="plan-feat ">
                          <span className="feat-text">
                            o Who it’s For: Very early-stage startups.
                          </span>
                        </li>
                        <li className="plan-feat ">
                          <span className="feat-text">
                            o Services: Basic guidance, idea validation, draft
                            business model creation, access to startup
                            resources, and community support.
                          </span>
                        </li>
                        <li className="plan-feat ">
                          <span className="feat-text">
                            o Key Goal: Equip startups with foundational support
                ...
                <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
                  ...
                  >
                    <div className="plan-head">
                      <i className="flaticon-virtual-reality plan-icon" />
                      <h4 className="plane-name">Beta plan (90 Days)</h4>
                      <div className="plan-price">
                        <h3 className="price">
                          101<sup className="currency-symbol">$</sup>
                        </h3>
                        <span className="per">Per Month</span>
                      </div>
                    </div>
                    <div className="plan-details">
                      <ul className="plan-list">
                        ...
                        <li className="plan-feat ">
                          {" "}
                          <span className="feat-text">
                            o Dedicated Mentors : 3
                          </span>
                        </li>
                        <li className="plan-feat ">
                          {" "}
                          <span className="feat-text">
                            o Who it’s For: Startups ready to move beyond
                            ideation.
                          </span>
                        </li>
                        <li className="plan-feat ">
                          {" "}
                          <span className="feat-text">
                            o Services: Business model refinement, MVP
                            development, and legal compliance assistance.
                          </span>
                        </li>
                        <li className="plan-feat ">
                          {" "}
                          <span className="feat-text">
                            o Key Goal: Guide startups in establishing MVP with
                ...
                <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
                  ...
                  >
                    <div className="plan-head">
                      <i className="flaticon-box plan-icon" />
                      <h4 className="plane-name">Gamma plan (90 Days)</h4>
                      <div className="plan-price">
                        <h3 className="price">
                          225<sup className="currency-symbol">$</sup>
                        </h3>
                        <span className="per">Per Month</span>
                      </div>
                    </div>
                    <div className="plan-details">
                      <ul className="plan-list">
                        ...
                        <li className="plan-feat ">
                          {" "}
                          <span className="feat-text">
                            o Dedicated Mentors : 4
                          </span>
                        </li>
                        <li className="plan-feat ">
                          {" "}
                          <span className="feat-text">
                            o Who it’s For: Startups seeking Product Market Fit
                          </span>
                        </li>
                        <li className="plan-feat ">
                          {" "}
                          <span className="feat-text">
                            o Services: Expanded mentorship, funding guidance,
                            and well curated product development offerings.
                          </span>
                        </li>
                        <li className="plan-feat ">
                          {" "}
                          <span className="feat-text">
                            o Key Goal: Product Market Fit with accelerated
                            growth through comprehensive support.
                          </span>
                        </li>
                      </ul>
                    </div>
                ...
                <div className="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
                  <div className="plan    wow fadeInUp  " data-wow-delay=".6s ">
                    <div className="plan-head">
                      <i className="flaticon-basic-shapes plan-icon" />
                      <h4 className="plane-name">Sigma Plan (90 Days)</h4>
                      <div className="plan-price">
                        <h3 className="price">
                          454<sup className="currency-symbol">$</sup>
                        </h3>
                        <span className="per">per month</span>
                      </div>
                    </div>
                    <div className="plan-details">
                      <ul className="plan-list">
                        ...
                        <li className="plan-feat ">
                          {" "}
                          <span className="feat-text">
                            o Who it’s For: Startups ready for expansion and
                            scale
                          </span>
                        </li>
                        <li className="plan-feat ">
                          ...
                          <span className="feat-text">
                            {" "}
                            o Services: Focus on fundraising, team expansion,
                        ...
                        <li className="plan-feat ">
                          ...
                          <span className="feat-text">
                            {" "}
                            o Key Goal: Board Formation, Empower startups to
                            scale effectively and access new growth
                            opportunities.
                          </span>
                        </li>
                      </ul>
          ...
          >
            <div
              ...
              data-bg-img="./assets/assets/images/sections-bg-images/1.jpg"
              data-bg-opacity=".25"
            >
              {" "}
            </div>
            <div className="container">
              <div className="sec-heading  centered ">
                <div className="content-area">
                  ...
                  <h2 className=" title    wow fadeInUp" data-wow-delay=".4s">
                    Startup <span className="hollow-text">testmonials</span>
                  </h2>
                </div>
              </div>
                          ...
                          <div className="testimonial-content">
                            <div className="customer-img ">
                              <img
                                className="img-fluid "
                                loading="lazy"
                                src="./assets/assets/images/testimonials/1.png"
                                alt="First Slide "
                              />
                            </div>
                            <div className="customer-testimonial">
                              <div className="content">
                                <p className="testimonial-text ">
                                  We were guided us through the complex process
                                  of scaling our business internationally. Their
                                  strategic planning, team-building resources,
                                  and funding preparation were top-notch. Today,
                                  we’re operating in multiple markets and are
                                  ready for our next stage of growth.
                                </p>
                              </div>
                            </div>
                            <div className="customer-info ">
                              <div className="customer-details">
                                <p className="customer-name">Taufiq Rachman</p>
                          ...
                          <div className="testimonial-content">
                            <div className="customer-img ">
                              <img
                                className="img-fluid "
                                loading="lazy"
                                src="./assets/assets/images/testimonials/2.png"
                                alt="First Slide "
                              />
                            </div>
                            <div className="customer-testimonial">
                              <div className="content">
                                <p className="testimonial-text ">
                                  The 3D virtual environment at EIM is an
                                  amazing platform for collaboration and growth.
                                  Being able to connect with mentors and other
                                  startups in an interactive and engaging space
                                  made a huge difference. This program helped me
                                  turn my vision into reality.ndis explicabo
                            ...
                            <div className="customer-info ">
                              <div className="customer-details">
                                <p className="customer-name">May Ling Tan</p>
                                <p className="customer-role">Malaysia</p>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="testimonial-content">
                            <div className="customer-img ">
                              <img
                                className="img-fluid "
                                loading="lazy"
                                src="./assets/assets/images/testimonials/3.png"
                                alt="First Slide "
                              />
                            </div>
                            <div className="customer-testimonial">
                              <div className="content">
                                <p className="testimonial-text ">
                                  The Gamma Phase of EIM was instrumental in
                                  helping me secure funding and expand my
                                  startup. The tailored mentorship and growth
                                  roadmaps gave me a clear strategy for scaling,
                                  which led to a 300% increase in revenue in
                                  just six months. Their support was
                                  exceptional!"
                                </p>
                              </div>
                            </div>
                            <div className="customer-info ">
                              <div className="customer-details">
                                <p className="customer-name">Fadilah Hassan,</p>
                                <p className="customer-role">
                        ...
                        <div className="testmonial-card d-flex align-items-center justify-content-center">
                          <div className="testimonial-content">
                            ...
                            <div className="customer-testimonial">
                              <div className="content">
                                <p className="testimonial-text ">
                                  We were provided invaluable support during our
                                  MVP development stage. Their AI-driven
                                  insights and business model refinement tools
                                  made a huge difference. Thanks to their help,
                                  I successfully launched my product and started
                            ...
                            <div className="customer-info ">
                              <div className="customer-details">
                                <p className="customer-name">Araya Nimit</p>
                                <p className="customer-role">
                                  Bangkok, Thailand
                                </p>
                              </div>
                        ...
                        <div className="testmonial-card d-flex align-items-center justify-content-center">
                          <div className="testimonial-content">
                            ...
                            <div className="customer-testimonial">
                              <div className="content">
                                <p className="testimonial-text ">
                                  "EIM’s Alpha Phase gave me the perfect
                                  starting point for my business idea. The
                                  mentorship and structured guidance helped me
                                  validate my concept and create a business
                                  model tailored to my market. I now feel
                                  confident in taking the next steps toward
                            ...
                            <div className="customer-info ">
                              <div className="customer-details">
                                <p className="customer-name">Rizky Pratama</p>
                                <p className="customer-role">
                                  Jakarta, Indonesia
                                </p>
                              </div>

    ...
    <>
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">FDI Intelligence </h1>
          ...
          <div className="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end  wow fadeInUp " data-wow-delay="0.6s">
            <div className="text-area ">
              <div className="sec-heading  light-title ">
                <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">FDI Intelligence Plateform</span>
                  <h2 className=" title    wow fadeInUp" data-wow-delay=".4s"><span className="hollow-text">FDI Intelligence Plateform</span></h2>
                </div>
              </div>
                                      <h3>
                                      FDI Intelligence Platform: Unlock Investment Opportunities with Precision
                                      </h3>
                                      <p>
                                      At the heart of the FDiMasters Suite, our FDI Intelligence Platform is your gateway to a world of investment insights and opportunities. Powered by an extensive in-house database, we specialize in identifying Indian companies with international expansion plans and investment potential.</p>
    ...
    <div className="container">
        ...
        <div className="col-12 col-md-6  col-lg-4 mx-auto ">
          ...
          <div className="box service-box  h-100 wow fadeInUp reveal-start" data-wow-offset={0} data-wow-delay=".1s">
            ...
            <div className="service-content">
              <h3 className="service-title">Comprehensive Indian Insights</h3>
                  <p className="service-text">
                  Our platform boasts a meticulously curated database of Indian companies and contacts, offering unparalleled accuracy. Every piece of information undergoes manual verification to ensure reliability.
              </p>
            </div>
          </div>
          ...
          <div className="box service-box  h-100 wow fadeInUp reveal-start" data-wow-offset={0} data-wow-delay=".2s">
            ...
            <div className="service-content">
              <h3 className="service-title">Industry-Focused Searches</h3>
                  <p className="service-text">
                  Tailor your searches to specific Indian industries across various sectors, allowing you to pinpoint investment prospects that align with your objectives.
              </p>
            </div>
          </div>
        ...
        <div className="col-12 col-md-6  col-lg-4 mx-auto  ">
          ...
          <div className="box service-box  h-100 wow fadeInUp reveal-start" data-wow-offset={0} data-wow-delay=".3s">
            ...
            <div className="service-content">
              <h3 className="service-title">Investment Potential Analysis</h3>
              <p className="service-text">Dive deep into individual companies to scan for signs of investment potential, helping you identify the most promising opportunities in the Indian market.</p>
                </div>
          ...
          <div className="box service-box  h-100 wow fadeInUp reveal-start" data-wow-offset={0} data-wow-delay=".4s">
            ...
            <div className="service-content">
              <h3 className="service-title">Effortless Customization</h3>
                  <p className="service-text">
                  Our platform empowers you to search, filter, sort, and export targeted lists effortlessly, streamlining your investment research and decision-making process.
              </p>
            </div>
          </div>

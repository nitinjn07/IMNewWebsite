        ...
        <div className="portfolio-group wow fadeIn" data-wow-delay=".4s">
          <div className="row ">
            <div className="col-12  col-md-6  col-lg-4  portfolio-item mobile ">
              <div className="item   "><a className="portfolio-img-link" href="#"><img className="portfolio-img   img-fluid " loading="lazy" src="/assets/assets/images/resources/1.png" alt="IM Podcast" /></a>
                <div className="item-info ">
                  <h3 className="item-title">Podcast</h3><i className="bi bi-arrow-right icon " />
                </div>
              </div>
            </div>
            <div className="col-12  col-md-6  col-lg-4  portfolio-item web  ">
              <div className="item   "><a className="portfolio-img-link" href="#"><img className="portfolio-img   img-fluid " loading="lazy" src="/assets/assets/images/resources/2.png" alt="IM Webinar" /></a>
                <div className="item-info ">
                  <h3 className="item-title">webinar</h3><i className="bi bi-arrow-right icon " />
                </div>
              </div>
            </div>
            <div className="col-12  col-md-6  col-lg-4  portfolio-item data ">
              <div className="item   "><a className="portfolio-img-link" href="https://srepublic.in/" target="_blank"><img className="portfolio-img   img-fluid " loading="lazy" src="/assets/assets/images/resources/3.png" alt="IM Blog" /></a>
                <div className="item-info ">
                  <h3 className="item-title">Startup Republic Blog</h3><i className="bi bi-arrow-right icon " />
                </div>
              </div>
            </div>

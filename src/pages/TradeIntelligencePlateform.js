    ...
    <>
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Trade Intelligence </h1>
          ...
          <div className="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end  wow fadeInUp " data-wow-delay="0.6s">
            <div className="text-area ">
              <div className="sec-heading  light-title ">
                <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">Trade Intelligence </span>
                  <h2 className=" title    wow fadeInUp" data-wow-delay=".4s"><span className="hollow-text">Trade Intelligence</span></h2>
                </div>
              </div>
                                      <h3>
                                      Trade Intelligence Platform: Unleash Market Insights with Precision
                                      </h3>
                                      <p>
          ...
          <div className="box service-box  h-100 wow fadeInUp reveal-start" data-wow-offset={0} data-wow-delay=".1s">
            ...
            <div className="service-content">
              <h3 className="service-title">Navigating Complex Terrain</h3>
                  ...
                  We provide essential information on import tariffs, taxes, and customs procedures in India, helping you efficiently manage the intricacies of cross-border trade.
              </p>
            </div>
          </div>
          ...
          <div className="box service-box  h-100 wow fadeInUp reveal-start" data-wow-offset={0} data-wow-delay=".2s">
            ...
            <div className="service-content">
              <h3 className="service-title">Compliance and Regulations</h3>
                  <p className="service-text">
                  Stay informed about commercial standards, regulations, and practices, ensuring your operations align with Indian business norms and intellectual property rights.
              </p>
            </div>
          </div>
        ...
        <div className="col-12 col-md-6  col-lg-4 mx-auto  ">
          ...
          <div className="box service-box  h-100 wow fadeInUp reveal-start" data-wow-offset={0} data-wow-delay=".3s">
            ...
            <div className="service-content">
              ...
              <p className="service-text">Access detailed market information, including distribution channels, business travel insights, and other invaluable data, to make informed decisions in the Indian market.</p>
                </div>
          ...
          <div className="box service-box  h-100 wow fadeInUp reveal-start" data-wow-offset={0} data-wow-delay=".4s">
            ...
            <div className="service-content">
              <h3 className="service-title">Strategic Insights</h3>
                  <p className="service-text">
                  Identify opportunities and best prospects tailored to your industry and company profile, ensuring you maximize your growth potential in India.
              </p>
            </div>
          </div>

        ...
        <div className="col-12 col-lg-6">
          ...
          <div className="hero-text-area   ">
            <div className="row">
              ...
              <div className="col-12">
                <div className="pre-title ">Export and Investment </div>
                <h1 className="hero-title  ">A Team who understands  <span className="featured-text">Trade <svg xmlns="http://www.w3.org/2000/svg" className="wavey-underline" width="1104.664" height="100.188" viewBox="0 0 1104.664 100.188">
              ...
              <div className="col-10">
                <p className="hero-subtitle ">Empowering startups to revolutionize local economic development well supported by our impact investment initiative, global market entry and expansion support.</p>
              </div>
              <div className="col-12">
                <div className="cta-links-area "><a className=" btn-outline cta-link cta-link-primary" href="#0">Know More</a>
          ...
          <div className="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end  wow fadeInUp " data-wow-delay="0.6s">
            <div className="text-area ">
              <div className="sec-heading  light-title ">
                <div className="content-area"><span className=" pre-title       wow fadeInUp " data-wow-delay=".2s">about
                    Us</span>
                  <h2 className=" title    wow fadeInUp" data-wow-delay=".4s"><span className="hollow-text">Cross  </span> Border
                  Innovation Promotion <span className="featured-text"> and Local Economic Development. </span></h2>
                </div>
              </div>
                    <p className=" about-text">
                    Empowering startups to revolutionize local economic development well supported by our impact investment initiative, global market entry and expansion support.
              </p>
                ...
                <div className="row ">
                  <div className="col-9 col-xl-6">
                    <div className="info-item"><i className="flaticon-medal  info-icon" />
                      <div className="info-content">
                        <h5 className="info-title">Incubators and Accelerators</h5>
                              <p className="info-text">
                              We create specialized incubators and accelerators in collaboration with local governments, fostering product development among youth and driving local economic growth.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-9 col-xl-6">
                    <div className="info-item"><i className="flaticon-game-console info-icon" />
                      <div className="info-content">
                        <h5 className="info-title">Cross Border Access of Innovation </h5>
                              <p className="info-text">
                              Incubation Masters enables startups to enter global markets with strategic guidance, networks, and cohort programs focused on solving government challenges, backed by investment support.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-9 col-xl-6">
                    <div className="info-item"><i className="flaticon-map info-icon" />
                      <div className="info-content">
                        <h5 className="info-title">Trade, Export & Investment Promotion</h5>
                        <p className="info-text">With a strong presence in key global markets, we connect closely with traders, exporters, and investors, representing government interests abroad to foster relationships and promote trade.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-9 col-xl-6">
                    <div className="info-item"><i className="flaticon-technical-support-1  info-icon" />
                      <div className="info-content">
                        ...
                        <p className="info-text">As economic development professionals, we combine deep market knowledge with strategic insights, understanding how industry trends and corporate strategies align to drive growth daily.
    ...
    <div className="container">
      <div className="sec-heading   centered ">
        <div className="content-area">
          <h2 className=" title    wow fadeInUp" data-wow-delay=".4s">OUR CUSTOMERS</h2>
        </div>
      </div>
        ...
        <div className="swiper-container">
          <div className="swiper-wrapper clients-logo-wrapper wow fadeIn " data-wow-delay=".02s">
            ...
            <div className="swiper-slide">
              <div className="client-logo  "><a href="#0"><img className="img-fluid logo " loading="lazy" src="./assets/assets/images/clients-logos/1.png" alt=" " /></a></div>
            </div>
            <div className="swiper-slide">
              <div className="client-logo "><a href="#0"><img className="img-fluid logo " loading="lazy" src="./assets/assets/images/clients-logos/2.png" alt=" " /></a></div>
            </div>
            <div className="swiper-slide">
              <div className="client-logo "><a href="#0"><img className="img-fluid logo " loading="lazy" src="./assets/assets/images/clients-logos/3.png" alt=" " /></a></div>
            </div>
            <div className="swiper-slide">
              <div className="client-logo "><a href="#0"><img className="img-fluid logo " loading="lazy" src="./assets/assets/images/clients-logos/4.png" alt=" " /></a></div>
            </div>

    ...
    <>
      <div>
        ...
        <section className="stats js-stats-counter mega-section">
          <div
            className="overlay-photo-image-bg"
            data-bg-img="./assets/assets/images/sections-bg-images/pattern-bg-3.jpg"
            data-bg-opacity=".2"
          />
          <div className="container">
            <div className="stats-inner">
              <div className="row ">
                ...
                <div className="col-12 col-md-6 col-lg-3 stat-box ">
                  <div className="stat-box-inner  " data-tilt="data-tilt">
                    <i className="flaticon-content-management stat-icon" />
                    <p className="stat-num ">
                      <span
                        className="counter"
                        data-from={0}
                ...
                <div className="col-12 col-md-6 col-lg-3 stat-box ">
                  <div className="stat-box-inner  " data-tilt="data-tilt">
                    <i className="flaticon-user stat-icon" />
                    <p className="stat-num ">
                      <span
                        className="counter"
                        data-from={0}
                ...
                <div className="col-12 col-md-6 col-lg-3 stat-box ">
                  <div className="stat-box-inner  " data-tilt="data-tilt">
                    <i className="flaticon-aim stat-icon" />
                    <p className="stat-num ">
                      <span
                        className="counter"
                        data-from={0}
